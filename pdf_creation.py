...
# for customer in customer_dic:
    ...
    visits = 9 # visits = customer.vists
    servings =170 # customer.total_servings
    total = "$94.65" # customer.total_price()
    ...
    # for purchase in customer.purchase_dic:
    ...
    pdf.output(f"Customer-PDFs/{customer_name}.pdf", 'F')